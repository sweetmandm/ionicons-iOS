...
//  Copyright © 2015 TapTemplate. All rights reserved.
//
...
class IonButton: UIButton {
    ...
    */
    ...
    @IBInspectable var ionIconName: String {
        get {
            return self.currentBackgroundImage!.description
        }
        set {
            self.setBackgroundImage(IonIcons.imageWithIcon(self.convertToUnicode(newValue), size: self.frame.size.width, color: .blackColor()), forState:UIControlState.Normal)
        }
    }
